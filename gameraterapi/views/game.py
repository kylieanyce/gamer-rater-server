...
class GameView(ViewSet):
    ...
    def create(self, request):
        ...
        game.game_time_length = request.data["gameTimeLength"]
        game.age_recommendation = request.data["ageRecommendation"]

        categories = Category.objects.get(pk=request.data["categoryId"])
...
class GameSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'title', 'description', 'designer', 'year_released',
                  'num_of_players', 'game_time_length', 'age_recommendation')
        depth = 1
